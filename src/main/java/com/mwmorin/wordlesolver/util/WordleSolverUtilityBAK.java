...
public class WordleSolverUtilityBAK {

	private static final Logger LOGGER = Logger.getLogger(WordleSolverUtilityBAK.class.getName());
...
/*		try (InputStream input = new FileInputStream("/config.properties")) { // NOT FINDING FILE !
	...
	public WordleSolverUtilityBAK(String sessionId) {
		super();
